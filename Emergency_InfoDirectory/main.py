...
def main():
    ...
    # doctors_csv=pd.read_csv('hotel.csv')
    # db=pd.read_csv('hospital.csv')
    # for i in range(len(db)):
    #     print(db)
    db = pd.read_csv('union_council.csv')
    for i in range(len(db)):
     print(db)

    # print(doctors_csv)
    # for i in range(len(doctors_csv)):
    #     print(doctors_csv['doc_id'][i],
    #     doctors_csv['name'][i],
    #     doctors_csv['speciality'][i],
    #     doctors_csv['chamber_name'][i],
    #     doctors_csv['consultation_hour'][i],
    #     doctors_csv['consultation_fee'][i],
    #     doctors_csv['contact_no'][i],
    #     doctors_csv['subdistrict'][i],
    #     doctors_csv['district'][i],
    #     doctors_csv['division'][i])
